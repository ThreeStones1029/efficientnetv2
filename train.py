...
if __name__ == '__main__':
    ...
    # dataset path
    parser.add_argument('--data-path', type=str, default="dataset/LA_preoperative_xray_fracture_cut_complete_augmented")
    ...
    parser.add_argument('--model_save_dir', type=str, default="weights/dataset/LA_preoperative_xray_fracture_cut_complete_augmented/m", help="trained models save path")
    parser.add_argument('--log_dir', type=str, default="runs/LA_preoperative_xray_fracture_cut_complete_augmented/m", help="tensorboard logdir save path")
