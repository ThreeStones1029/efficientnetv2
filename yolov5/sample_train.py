...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "runs/train/buu_drr_pretrain/weights/best.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="yolov5x.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/xray20240119_semantic.yaml", help="dataset.yaml path")
    ...
    parser.add_argument("--name", default="xray20240119_semantic1", help="save to project/name")
