...
LastEditTime: 2024-04-12 08:55:58
'''
import os
import sys
import argparse
...
def get_detection_result(infer_dir, infer_image, is_run_detection, bbox_json_file):
    """
    ...
    """
    imageid2bboxes = {}
    detection_data = load_json_file(bbox_json_file)
...
def main(args):
    ...
    # 实例化验证数据集
    test_images_path = get_detection_result(args.infer_dir, args.infer_image)
